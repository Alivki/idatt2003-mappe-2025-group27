...
/**
 * Unit test for the class {@link EasyMathQuestion}.
 *
 * <p>Verifies that EasyMathQuestion generate questions correctly</p>
 */
class EasyMathQuestionTest {
  private EasyMathQuestion question;
   ...
   */
  @Test
  @DisplayName("test throws exeption when answer is wrong")
